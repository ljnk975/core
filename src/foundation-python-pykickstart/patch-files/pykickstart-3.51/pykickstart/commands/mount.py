...
# ROCKS8 backport from pykickstart-1.99.66.22: pykickstart/commands/mount.py
...
class RHEL7_Mount(KickstartCommand):
    ...
    def _getParser(self):
        ...
        op.add_argument("--reformat", dest="reformat", default=False)
        op.add_argument("--mkfsoptions", dest="mkfs_opts", action="store")
        op.add_argument("--mountoptions", dest="mount_opts", action="store")
