...
# ROCKS8 backport from pykickstart-1.99.66.22: pykickstart/commands/snapshot.py
...
class RHEL7_Snapshot(KickstartCommand):
    ...
    def _getParser(self):
        ...
        op.add_argument("--name", dest="name", required=True, type="string")
        op.add_argument("--when", action="callback", callback=when_cb,
