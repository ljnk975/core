...
class _M2CryptoBuildExt(build_ext.build_ext):
    ...
    def finalize_options(self):
        ...
        self.include_dirs.append(os.path.join(self.openssl, '/opt/rocks/include'))
        ...
        self.swig_opts.append('-I/opt/rocks/include -includeall')
...
m2crypto = setuptools.Extension(name='M2Crypto._m2crypto',
                                ...
                                extra_link_args = ['-L/opt/rocks/lib -lcrypto -lssl'],
