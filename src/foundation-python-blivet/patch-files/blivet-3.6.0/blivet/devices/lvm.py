...
# ROCKS8 python2 backport for raise from
# https://stackoverflow.com/questions/27318327
    ...
    def _create(self):
        ...
        if self._cache_mode:
            try:
                ...
                # ROCKS8
                raise_from(errors.DeviceError,e)
...
class LVMLogicalVolumeDevice(LVMLogicalVolumeBase, LVMInternalLogicalVolumeMixin, LVMSnapshotMixin,
    ...
    def attach_writecache(self, writecache_lv):
        ...
        try:
            ...
            # ROCKS8
            raise_from(errors.DeviceError("Failed to attach writecache to %s" % self.name),err)
...
class LVMWriteCache(Cache):
    ...
    def detach(self):
        try:
            ...
            # ROCKS8
            raise_from(errors.DeviceError("Failed to detach writecache from %s" % self._cached_lv.lvname), err)
