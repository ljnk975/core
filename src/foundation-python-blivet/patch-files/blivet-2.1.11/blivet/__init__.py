...
import logging
# ROCKS8: Drop annoying console messages "No handlers could be found for logger "testdata""
# https://python.readthedocs.io/en/v2.7.2/howto/logging.html#useful-handlers
...
# ROCKS8: removed btrfs plugin from _REQUESTED_PLUGIN_NAMES
if arch.is_s390():
    _REQUESTED_PLUGIN_NAMES = set(("lvm", "swap", "crypto", "loop", "mdraid", "mpath", "dm", "s390"))
else:
    _REQUESTED_PLUGIN_NAMES = set(("lvm", "swap", "crypto", "loop", "mdraid", "mpath", "dm"))
